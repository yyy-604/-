...
public class SignUpForm extends JFrame {
    ...
    private void handleSignUp() {
        ...
        newUser.setCars(new ArrayList<>()); // 차량 없음
        newUser.setUserTypeTags("");        // 공백
        newUser.setFilterOption(null);      // null 가능
        newUser.setParkingPassIDList(new ArrayList<>()); // 없음
        newUser.setFavorites(new ArrayList<>());         // 없음
